// // src/main/java/com/stylenest/ProductService/service/EventPublisherService.java
...
//     public void publishStockReservationEvent(Integer productId, Integer quantity,
//                                              String orderId, String userId, String eventType) {
//         StockReservationEvent event = new StockReservationEvent(
//                 productId, quantity, orderId, userId, LocalDateTime.now(), eventType
//         );
//        rabbitTemplate.convertAndSend("stock.exchange", "stock.reservation", event);
//     }

//     public void publishStockUpdateEvent(Integer productId, Integer newStock,
//                                         Integer reservedStock, String orderId, String eventType) {
